...
MOB_SPRITES_JS = Path("/mnt/data/hello-world/static/clungiverse/mob-sprites.js")
MOB_IMAGES_DIR = Path("/mnt/data/hello-world/static/mob-images")
RENDER_SPRITE_SCRIPT = Path("/mnt/data/scripts/render-mob-sprite.js")
